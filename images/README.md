...
4. Then click 'Manage', then 'Create Credentials' to create an api for your self.		
5. Once you have it, enter it into the code where I have written ${config.API_Key} in the js/script.js file and run the index.html file in a browser. 	
6. Enjoy!	
