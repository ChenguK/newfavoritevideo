...
I responded by saying that it actually was stopping the video from playing, but that I had already written new code to allow an image in the modal to open the# Your New Favorite Video
...
![Wireframe with search bar](./images/Wireframe1.png)

![Wireframe with modal](./images/Wireframe2.png)                     

# App Screenshots

![Screenshot of finished app home screen](./images/Screenshot%203.png) 

![Screenshot of finished app search](./images/Screenshot1.png)

![Screenshot of finished app with modal](./images/Screenshot2.png)
...
* Thank you to anyone whose code inspired me (all of SEI-R 629) and to all those who helped me create this site.
 video in a new window so I was fine without it.	
